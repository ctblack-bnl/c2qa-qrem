...
## Specification Document v0.8

**Version:** 0.8 — Per-material stratification, derived_material column, Findings tab, Explorer UI improvements
**Date:** May 5, 2026
**Status:** Operational — 98 papers, 155 samples, ~1,318 catchall items, 100% profile coverage
...
## Current Corpus State (May 5, 2026)
...
| Mining findings approved | 1 positive + several inconclusive |
...
| Phase 5 — SI file linking | Planned | DOI-based naming convention; single logical record per paper+SI pair |
